...
public class MainActivity extends Activity {
    ...
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.kier.bluetooth.le" + "" + ".ACTION_GATT_SERVICES_DISCOVERED";
    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            if (mLeDevices.size() > 0) {
                device = mBluetoothAdapter.getRemoteDevice(mLeDevices.get(0)
                        .getAddress());
                Log.i("Apian", device.toString());
                deviceTitle = mBluetoothAdapter.getRemoteDevice(
                        mLeDevices.get(0).getAddress()).getName()
                        + "";
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                ToastUtil.showToast(getApplication(),
                        getApplication().getResources().getString(R.string.bt_over),
                        Toast.LENGTH_SHORT);
//                mayRequestLocation();
                checkBluetooth();
            } else if (msg.what == 3) {
